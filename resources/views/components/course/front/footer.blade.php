            ...
            <div class="space-y-6">
                ...
                <div class="flex space-x-4">
                    <a href="#"
                        ...
                        <img src="{{ asset('laos-course/front/assets/img/wa.svg') }}" alt="WhatsApp" class="w-5 h-5" />
                    </a>
                    <a href="#"
                        class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-green-500 transition-colors duration-300">
                        <img src="{{ asset('laos-course/front/assets/img/ig.svg') }}" alt="Instagram" class="w-5 h-5" />
                    </a>
                    <a href="#"
                        class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-green-500 transition-colors duration-300">
                        <img src="{{ asset('laos-course/front/assets/img/gh.svg') }}" alt="Github" class="w-5 h-5" />
                    </a>
                </div>
            </div>
