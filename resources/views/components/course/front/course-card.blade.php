...
<div class="course-card bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 rounded-2xl overflow-hidden transform transition-all"
    ...
    <div class="relative">
        ...
        <div
            class="course-hover-content cursor-pointer absolute inset-0 bg-black/75 flex items-center justify-center opacity-0 transform translate-y-4 transition-all duration-300 backdrop-blur-sm">
            <button
    ...
    <div class="p-4 sm:p-6">
        <div class="flex flex-wrap items-center justify-between mb-4">
            <span
                class="px-3 py-1 bg-green-100/50 dark:bg-green-900/50 text-green-600 dark:text-green-400 rounded-xl text-xs sm:text-sm font-medium backdrop-blur-sm mb-2 sm:mb-0">
            ...
            <div class="flex items-center space-x-3 sm:space-x-4">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-xs sm:text-sm text-gray-600 dark:text-gray-400">5</span>
                </div>
                <div class="flex items-center">
                    ...
                    <span
                        class="ml-1 text-xs sm:text-sm text-gray-600 dark:text-gray-400">{{ $course->course_students_count }}
                        Student</span>
                </div>
            </div>
        </div>
        <a href="{{ route('course.show', $course->slug) }}"
            class="text-lg sm:text-xl font-bold text-gray-900 dark:text-white block mb-2 hover:text-green-500 duration-300 transition-all">{{ $course->judul }}</a>
        ...
        <div class="flex items-center justify-between mt-5">
            <div class="flex items-center">
                ...
                <span class="ml-2 text-gray-600 dark:text-white text-xs sm:text-sm">
                    {{ $course->course_mentors_count }} Mentor
                </span>
            </div>
