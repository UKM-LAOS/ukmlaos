<header class="hidden lg:flex bg-white dark:bg-gray-800 shadow-md p-4 justify-between items-center">
    <div>
        <h2 class="text-xl font-semibold text-gray-800 dark:text-white">Dashboard Student</h2>
    </div>
        ...
        <div class="relative">
            <button class="flex items-center space-x-3 focus:outline-none">
                <div class="relative w-10 h-10">
                    ...
                    <img src="{{ Auth::user()?->avatar_url ?? 'https://ui-avatars.com/api/?name=' . Auth::user()->name . '&background=16a34a&color=fff&bold=true&font-family=Poppins' }}"
                        alt="User"
                ...
                <div class="hidden md:block text-left">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        {{ strtoupper(implode(',', Auth::user()->getRoleNames()->toArray())) }}
                    </p>
                </div>
            </button>
        </div>
