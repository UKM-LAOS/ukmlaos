...
@section('content')
    <!-- Hero Section -->
    <section
        class="relative pt-28 pb-24 md:pt-36 md:pb-32 overflow-hidden bg-gradient-to-b from-white via-green-50/30 to-green-100/20 dark:from-gray-900 dark:via-gray-800/30 dark:to-[#151E2E]">
            ...
            <svg class="absolute bottom-0 left-0 w-full h-full text-green-300 dark:text-green-800 opacity-40 dark:opacity-20"
                ...
                <defs>
                    <pattern id="arcPattern" width="240" height="240" patternUnits="userSpaceOnUse">
                        ...
                        <path d="M120 0 A120 120 0 0 1 240 120 L120 120 Z" fill="currentColor" fill-opacity="0.15" />

                        <path d="M0 120 A120 120 0 0 1 120 240 L0 240 Z" fill="currentColor" fill-opacity="0.08" />
                    </pattern>
                </defs>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
            <div class="grid md:grid-cols-[1.1fr_1fr] gap-14 md:gap-16 items-center">
                ...
                <div class="space-y-8 md:space-y-10 mr-0 md:-mr-8">
                    ...
                    <!-- Hero Text -->
                    <h1
                        class="text-4xl sm:text-5xl md:text-6xl lg:text-[3.5rem] font-bold leading-tight text-gray-900 dark:text-white">
                        Selamat Datang,
                ...
                <div class="relative hidden md:block ml-auto w-full max-w-lg">
                    ...
                    <div
                        class="absolute inset-0 bg-green-50 dark:bg-green-900/50 rounded-full blur-3xl opacity-20 -right-10">
                    </div>
                    ...
                    <div class="relative z-10 grid grid-cols-2 gap-5 w-full">
                        ...
                        <div
                            class="aspect-square bg-green-500/10 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-lg transform translate-y-8">
                            <img src="{{ asset('assets/cp/img/avatar/avatar1.png') }}" alt="LAOS Mascot 1"
                                class="w-full h-full object-cover transform hover:scale-105 transition-transform duration-500">
                        </div>


                        <div
                            class="aspect-square bg-green-500/10 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-lg transform translate-y-2">
                            <img src="{{ asset('assets/cp/img/avatar/avatar2.png') }}" alt="LAOS Mascot 2"
                                class="w-full h-full object-cover transform hover:scale-105 transition-transform duration-500">
                        </div>


                        <div
                            class="aspect-square bg-green-500/10 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-lg transform translate-y-5">
                            <img src="{{ asset('assets/cp/img/avatar/avatar3.png') }}" alt="LAOS Mascot 3"
                                class="w-full h-full object-cover transform hover:scale-105 transition-transform duration-500">
                        </div>
                        ...
                        <div
                            class="aspect-square bg-green-500/10 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-lg transform translate-y-2">
                            <img src="{{ asset('assets/cp/img/avatar/avatar4.png') }}" alt="LAOS Mascot 4"
                                class="w-full h-full object-cover transform hover:scale-105 transition-transform duration-500">
                        </div>
                    </div>
                </div>
    ...
    <section id="manfaat"
        ...
        <div class="absolute inset-0">
            ...
            <div class="absolute bottom-0 left-0 w-full h-full bg-[#E3F7F2] dark:bg-green-900/20 clip-path-full-slant">
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Relasi Card -->
                <div
                    class="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 flex flex-col h-full overflow-hidden">
                    <!-- Green glow on hover -->
                    <div
                        class="absolute inset-0 rounded-2xl bg-green-500/10 dark:bg-green-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    </div>
                    <!-- Image Container -->
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 max-w-[1200px] mx-auto">
                @foreach ($divisis->take($top) as $d)
                    <div class="w-full h-[240px]">
                        <div
                            class="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 flex h-full">
                            <div
                                class="w-1/3 p-6 flex items-center justify-center bg-green-300 dark:bg-green-900/30 rounded-l-2xl">
