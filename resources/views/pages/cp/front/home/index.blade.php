        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative hidden md:block">
                    ...
                    <img src="{{ asset('laos-cp/maskot-1.png') }}" alt="LAOS Mascot"
                ...
                <div
                    ...
                    <div class="relative">
                        <div class="mb-6 relative">
                            ...
                            <img src="{{ asset('laos-cp/networking.png') }}" alt="Networking"
                ...
                <div
                    ...
                    <div class="relative">
                        <div class="mb-6 relative">
                            ...
                            <img src="{{ asset('laos-cp/cloud-data.png') }}" alt="Cloud Data"
                                class="relative w-16 h-16 mx-auto transform group-hover:scale-110 transition-transform duration-500" />
                        </div>
                ...
                <div
                    ...
                    <div class="relative">
                        <div class="mb-6 relative">
                            ...
                            <img src="{{ asset('laos-cp/license.png') }}" alt="License"
                                class="relative w-16 h-16 mx-auto transform group-hover:scale-110 transition-transform duration-500" />
                        </div>
                ...
                <div
                    ...
                    <div class="relative">
                        <div class="mb-6 relative">
                            ...
                            <img src="{{ asset('laos-cp/hums.png') }}" alt="Humas"
                                class="relative w-16 h-16 mx-auto transform group-hover:scale-110 transition-transform duration-500" />
                        </div>
                ...
                <div
                    ...
                    <div class="relative">
                        <div class="mb-6 relative">
                            ...
                            <img src="{{ asset('laos-cp/pemro.png') }}" alt="Programming"
                                class="relative w-16 h-16 mx-auto transform group-hover:scale-110 transition-transform duration-500" />
                        </div>
                ...
                <div
                    ...
                    <div class="relative">
                        <div class="mb-6 relative">
                            ...
                            <img src="{{ asset('laos-cp/cysec.png') }}" alt="Cyber Security"
                                class="relative w-16 h-16 mx-auto transform group-hover:scale-110 transition-transform duration-500" />
                        </div>
                ...
                <div
                    ...
                    <div class="relative">
                        <div class="mb-6 relative">
                            ...
                            <img src="{{ asset('laos-cp/mulmed.png') }}" alt="Multimedia"
                                class="relative w-16 h-16 mx-auto transform group-hover:scale-110 transition-transform duration-500" />
                        </div>
