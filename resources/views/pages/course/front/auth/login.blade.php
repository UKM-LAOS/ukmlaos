...
@section('content')
    ...
    <section
        ...
        <div class="relative z-10 w-full max-w-5xl mx-auto flex items-center justify-center mt-20">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden w-full max-w-4xl">
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="w-full md:w-1/2 p-6 sm:p-8">
                        ...
                        <!-- Login Form -->
                        <form method="POST" action="{{ route('course.authenticate') }}" class="space-y-4 sm:space-y-6">
                            @csrf
