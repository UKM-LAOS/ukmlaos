                            ...
                            <div class="flex flex-col md:flex-row">
                                ...
                                <div class="p-4 md:p-5 md:w-2/3">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex items-center mb-3">
                                                ...
                                                <div class="flex items-center text-yellow-400">
                                                    ...
                                                    <span class="ml-1 text-sm text-gray-600 dark:text-gray-400">4.9</span>
                                                    <span class="mx-1.5 text-gray-400">•</span>
                                                    <span class="text-sm text-gray-600 dark:text-gray-400">2,546
                                                        students</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex items-center text-sm text-gray-600 dark:text-gray-400 mb-3">
                                        ...
                                        <span>{{ $course->course_chapter_lessons_count }} Materi</span>
                                        ...
                                        <span>{{ $course->course_chapters_count }} Bab</span>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-2">
                                            <span
                                                class="text-sm font-medium text-gray-900 dark:text-white">{{ $course->course_mentors_count }}
                                                Mentor</span>
                                            {{-- <p class="text-xs text-gray-600 dark:text-gray-400">Laravel Expert & Senior
                                                Developer</p> --}}
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/30 p-4 rounded-xl">
                                <div class="flex flex-col sm:flex-row gap-3">
                                    <input type="text" id="promoCode" placeholder="Masukkan kode promo" name="kode"
                        ...
                        <div class="space-y-4 bg-gray-50 dark:bg-gray-700/30 p-4 rounded-xl">
                            ...
                            <div
                                ...
                                <span id="grandTotal" class="text-xl font-bold text-green-600 dark:text-green-500">
                                    {{ $course->tipe->value === 'premium' ? 'Rp' . number_format($course->harga + 15000, 0, ',', '.') : 'Rp' . number_format($course->harga, 0, ',', '.') }}
                                </span>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script>
        ...
        const taxAmount = 15000; // Fee Payment Gateway
        ...
        function beli() {
            let diskon = $('input[name="kode"]').val() || null;
            $.ajax({
                url: `{{ route('course.checkout', $course->slug) }}`,
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    kode: diskon,
                ...
                success: function(response) {
                    ...
                    snap.pay(response.data.snap_token, {
                        ...
                        onSuccess: function(result) {
                            ...
                            window.location.href = '{{ route('course.pembayaran.sukses') }}';
                        },
                        // Optional
                        onPending: function(result) {
                            /* You may add your own js here, this is just example */
                            window.location.href = '{{ route('course.pembayaran.gagal') }}';
                        },
                        // Optional
