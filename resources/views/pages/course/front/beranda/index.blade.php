        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative hidden md:block mt-24">
                    ...
                    <img src="{{ asset('laos-course/front/assets/img/hero-ilustration.png') }}" alt="Hero"
                ...
                <div
                    ...
                    <div class="relative">
                        <div class="mb-6 relative">
                            ...
                            <img src="{{ asset('laos-course/front/assets/img/programming.png') }}" alt="Programming"
                ...
                <div
                    ...
                    <div class="relative">
                        <div class="mb-6 relative">
                            ...
                            <img src="{{ asset('laos-course/front/assets/img/cyber-security.png') }}" alt="Cyber Security"
                                class="relative w-16 h-16 mx-auto transform group-hover:scale-110 transition-transform duration-500" />
                        </div>
                ...
                <div
                    ...
                    <div class="relative">
                        <div class="mb-6 relative">
                            ...
                            <img src="{{ asset('laos-course/front/assets/img/design.png') }}" alt="Design"
                                class="relative w-16 h-16 mx-auto transform group-hover:scale-110 transition-transform duration-500" />
                        </div>
                ...
                <div
                    ...
                    <div class="relative">
                        <div class="mb-6 relative">
                            ...
                            <img src="{{ asset('laos-course/front/assets/img/digital-marketing.png') }}"
                    ...
                    <div class="relative">
                        <div class="flex items-center mb-6">
                            <div class="relative">
                                ...
                                <img src="{{ asset('laos-course/front/assets/img/testimonial-avatar.png') }}"
                                    alt="Avatar"
                            ...
                            <div class="ml-4">
                                <h3
                                    ...
                                    Christianus Yoga</h3>
                                <p class="text-green-500 dark:text-green-400">Senior Developer</p>
                            </div>
                        </div>

                        <div class="flex gap-1 mb-4">
                            <img src="{{ asset('laos-course/front/assets/img/star.svg') }}" alt="star"
                                class="w-5 h-5">
                            <img src="{{ asset('laos-course/front/assets/img/star.svg') }}" alt="star"
                                class="w-5 h-5">
                            <img src="{{ asset('laos-course/front/assets/img/star.svg') }}" alt="star"
                        ...
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            "The course content is exceptional and the mentors are incredibly knowledgeable. I've
                            learned more in 3 months than I did in a year of self-study."
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="relative">
                        <div class="flex items-center mb-6">
                            <div class="relative">
                                <div
                                    class="absolute inset-0 bg-blue-200 dark:bg-blue-700 rounded-full blur group-hover:bg-blue-300 dark:group-hover:bg-blue-600 transition-colors duration-300">
                                </div>
                                <img src="{{ asset('laos-course/front/assets/img/testimonial-avatar.png') }}"
                                    alt="Avatar"
                                    class="relative w-14 h-14 rounded-full border-4 border-white dark:border-gray-700 shadow-lg group-hover:scale-105 transition-transform duration-300" />
                            ...
                            <div class="ml-4">
                                <h3
                                    ...
                                    Sarah Johnson</h3>
                                <p class="text-blue-500 dark:text-blue-400">UI/UX Designer</p>
                            </div>
                        </div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            "The UI/UX design course completely transformed my approach to design. The practical
                            projects and mentor feedback were invaluable."
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="relative">
                        <div class="flex items-center mb-6">
                            <div class="relative">
                                <div
                                    class="absolute inset-0 bg-purple-200 dark:bg-purple-700 rounded-full blur group-hover:bg-purple-300 dark:group-hover:bg-purple-600 transition-colors duration-300">
                                </div>
                                <img src="{{ asset('laos-course/front/assets/img/testimonial-avatar.png') }}"
                                    alt="Avatar"
                                    class="relative w-14 h-14 rounded-full border-4 border-white dark:border-gray-700 shadow-lg group-hover:scale-105 transition-transform duration-300" />
                            ...
                            <div class="ml-4">
                                <h3
                                    ...
                                    Michael Chen</h3>
                                <p class="text-purple-500 dark:text-purple-400">Security Analyst</p>
                            </div>
                        </div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            "The cybersecurity program gave me hands-on experience with real-world scenarios. Now I feel
                            confident in my ability to protect systems."
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative">
                    ...
                    <img src="{{ asset('laos-course/front/assets/img/subscription-now-image.png') }}"
                        alt="Start Learning" class="relative rounded-3xl shadow-xl w-full h-auto" />
                </div>
