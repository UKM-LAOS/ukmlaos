        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <div class="flex items-center text-gray-600 dark:text-gray-400">
                    <span
                        ...
                        {{ ucwords(str_replace('-', ' ', $course->kategori->label())) }}
                    </span>
                    <div class="flex items-center mr-6">
                        ...
                        <span class="ml-1">4.9 (128 reviews)</span>
                    </div>
                    <div class="flex items-center">
                        ...
                        <span>875 students enrolled</span>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                ...
                <div class="col-span-1 lg:col-span-2 rounded-2xl overflow-hidden flex flex-col h-[300px] md:h-[500px]"
                    ...
                    <div class="relative w-full h-full"> <!-- Changed to flex-grow -->
                        <div class="absolute inset-0 bg-gray-800 flex items-center justify-center">
                            @if (isset($course->courseChapterLessons[0]->youtube_url))
                                @php
                                    ...
                                    if (
                                        preg_match(
                                            '/[\\?\\&]v=([^\\?\\&]+)/',
                                            $course->courseChapterLessons[0]->youtube_url,
                                            $matches,
                                        )
                                    ) {
                                        $videoId = $matches[1];
                ...
                <div
                    ...
                    <div class="relative">
                        <span
                            class="inline-block px-4 py-1 bg-green-100 dark:bg-green-900/50 text-green-600 dark:text-green-300 rounded-full text-sm font-medium mb-2">{{ ucwords($course->tipe->label()) }}
                            Course</span>
                        <div class="text-3xl font-bold text-green-500 dark:text-green-400 mb-6 flex items-baseline">
                            {{ 'Rp' . number_format($course->harga, 0, ',', '.') }}
                            <span class="text-sm text-gray-500 dark:text-gray-400 ml-2 font-normal">/ one-time
                                payment</span>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="flex items-center group">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ $course->course_chapters_count }}
                                        Bab</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center group">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                        {{ $course->course_chapter_lessons_count }} Materi</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center group">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ $course->course_mentors_count }}
                                        Mentor</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="relative z-10">
                        @if ($course->tipe === TipeEnum::PREMIUM)
                            <a href="{{ route('course.checkout', $course->slug) }}"
                        ...
                        @else
                            <form action="{{ route('course.daftar', $course->slug) }}" method="post">
                                @csrf
                                <button type="submit"
                                    class="w-full py-3 mb-3 bg-green-500 dark:bg-green-600 text-white rounded-xl hover:bg-green-600 dark:hover:bg-green-700 transition-colors font-medium shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-transform flex items-center justify-center gap-2">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="accordion">
                                    ...
                                    <div
                                        ...
                                        <div class="p-4 border-t border-gray-200 dark:border-gray-700">
                                            <ul class="space-y-3">
                                                @foreach ($chapter->courseChapterLessons as $lesson)
                    ...
                    <div id="reviews" class="tab-content">
                        <div class="flex items-center justify-between mb-8">
                            <div>
                                ...
                                <p class="text-gray-500 dark:text-gray-400">128 reviews for this course</p>
                            </div>
                            <div class="flex items-center">
                                <div class="mr-4">
                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 pb-6 mb-6">
                            <div class="flex items-center mb-4">
                                <img src="/api/placeholder/40/40" alt="Reviewer" class="w-10 h-10 rounded-full mr-4">
                                <div>
                                    <h4 class="font-medium text-gray-900 dark:text-white">Michael Chen</h4>
                                    <p class="text-gray-500 dark:text-gray-400 text-sm">2 weeks ago</p>
                                </div>
                            ...
                            <p class="text-gray-700 dark:text-gray-300">
                                This course is amazing! I've learned so much about Python and data science in just a few
                                weeks. The instructor is very knowledgeable and explains everything clearly.
                            </p>
                        </div>
                    </div>
                </div>
