...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('laos-course/back/assets/css/style.css') }}">
...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen font-poppins">
    ...
    <div class="flex">
        <!-- Mobile Header -->
        @include('components.course.back.topbar')

        <!-- Sidebar -->
        @include('components.course.back.aside')

        <!-- Main Content -->
        <main class="w-full lg:ml-64 min-h-screen pt-16 lg:pt-0">
            <!-- Top Bar (Desktop) -->
            @include('components.course.back.topbar-desktop')
